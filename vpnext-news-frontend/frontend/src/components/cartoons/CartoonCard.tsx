        ...
        <div>
          ...
          <div className="flex items-center justify-between px-5 py-2.5 bg-[#FBBF24]">
            <span className="font-black text-[10px] uppercase tracking-[0.18em] text-[#141210]">
              {viewMode === "webtoon" ? "AI NEWS COMIC (웹툰 연속 보기)" : `AI NEWS COMIC (${currentPanelIndex + 1}/${totalPanels})`}
            </span>
            <span className="text-[9px] font-bold text-[#141210]/45 tracking-[0.1em]">
              {viewMode === "webtoon" ? "Generated by AI · 스크롤하여 감상" : "Generated by AI · 탭하여 크게 보기"}
            </span>
          </div>
              ...
              {item.comic_urls.map((scene, idx) => {
                ...
                return (
                  <div key={idx} className="w-full max-w-[480px] flex flex-col items-center border-b border-white/5 pb-8 last:border-0 last:pb-0">
                    ...
                    <div className="w-full overflow-hidden bg-[#0A0806] rounded-2xl border border-white/10 shadow-[0_4px_16px_rgba(0,0,0,0.4)] transition-transform duration-300 hover:scale-[1.01] cursor-zoom-in" onClick={handleOpenLightbox}>
