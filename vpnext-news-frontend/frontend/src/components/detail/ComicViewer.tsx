    ...
    >
      ...
      {comicUrls ? (
        <Link
          ...
          className="px-8 py-3.5 text-lg font-black transition-all duration-200 inline-block bg-purple-600 text-white rounded-2xl hover:bg-purple-700 hover:-translate-y-0.5 active:translate-y-0 shadow-[0_4px_16px_rgba(124,58,237,0.3)] hover:shadow-[0_6px_20px_rgba(124,58,237,0.4)] cursor-pointer"
        >
          보러가기 (AI 만화 모음집)
        </Link>
      ) : (
