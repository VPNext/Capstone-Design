...
1. 극단적 대사 압축: 말풍선 대사는 1~2어절(최대 5글자)의 직관적인 감탄사/핵심 단어만 사용하세요. (예: "헉!", "올랐다!", "안돼!", "대박!")
2. 전연령 코믹 웹툰 화풍 고정: 프롬프트 전반에 귀엽고 과장된 캐릭터와 밝은 색감을 지시하세요. 
   (필수 포함 키워드: "Korean casual webtoon style, cute SD characters, highly expressive comic style, family-friendly, vibrant colors")
3. 직관적인 시각적 비유: 어려운 정치/경제 뉴스라도 어린이도 이해할 수 있는 쉬운 상황으로 묘사하세요. 
   (예: 주식 폭락 -> 미끄럼틀을 타고 내려오며 우는 캐릭터 / 물가 상승 -> 무거운 바구니를 들고 땀 흘리는 캐릭터)
